          ...
          <div className={styles.Board}>
            <ul className="menu-content_elements">
              ...
              <li>
                ...
                <Link onClick={handleLinkClick} href="/">Notas</Link>
              </li>
            </ul>
          </div>
        </div>
